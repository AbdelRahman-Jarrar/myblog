...
<?php
        echo" <div class='pagination'>";
                ...
                if($page>1)
                {
                    echo "<a href='pagination.php?page=".($page-1)."' class='   '>&laquo</a>";
                }

                for($i=1;$i<=$number_of_pages;$i++)
                {
                    echo "<a href='pagination.php?page=".$i."' class='' ".(($page == $i) ? 'style="color:#ECF0F1;"':'').">$i</a>";
                }

                if( ($i - 1) > $page )
                {

                    echo "<a href='pagination.php?page=".($page+1)."' class=''>&raquo</a>";
                }
                // if($i >$page){
                //     header("pagination.php?page=");
                // }
